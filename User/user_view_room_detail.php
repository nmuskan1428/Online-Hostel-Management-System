		...
		if($row>0)
		{
			...
			while($data=mysqli_fetch_array($run))
			{
				...
				<div class="row" style="border:1px solid #000; padding:10px; margin:10px">
					<div class="col-sm-2 col-xs-12" style="border-right:1px solid; border-bottom:1px solid #000000">
						<p style="font-size:18px; color:#990000">Room Type</p>
						<p style="color:#000000; font-weight:700"><?php echo $data['room_type'] ?></p>
					</div>
					<div class="col-sm-1 col-xs-12" style="border-right:1px solid; border-bottom:1px solid #000000">
					...
					<div class="col-sm-2 col-xs-12" style="border-bottom:1px solid #000000">
						<p style="font-size:18px; color:#990000">Status</p>
						<p style="color:#000000; font-weight:700"><?php echo $data['status'] ?></p>
					</div>
					<div class="col-sm-2 col-xs-12" style="border-right:1px solid">
						<p style="font-size:18px; color:#990000">Food Type</p>
						<p style="color:#000000; font-weight:700"><?php echo $data['food_type'] ?></p>
					</div>
					<div class="col-sm-2 col-xs-12">
						<p style="font-size:18px; color:#990000">Mess Charge</p>
						<p style="color:#000000; font-weight:700"><?php echo $data['mess_charge'] ?>/- Per Month</p>
					</div>
